...
export const NavMemoIcon = ({ size = 26, color = 'currentColor', active = false, fillColor = '#F9C93B', ...p }) => (
  <svg width={size} height={size} viewBox="0 0 26 26" fill="none" xmlns="http://www.w3.org/2000/svg" {...p}>
    <path d="M3.3255 11.4888V15.9954C3.3255 18.8279 3.3255 20.2442 4.23933 21.1242C5.15315 22.0042 6.62393 22.0042 9.5655 22.0042H15.8055C18.747 22.0042 20.2178 22.0042 21.1317 21.1242C22.0455 20.2442 22.0455 18.8279 22.0455 15.9954V11.4888" stroke={color} strokeWidth="1.5" />
    <path d="M7.48547 18.4766H11.6455" stroke={color} strokeWidth="1.5" strokeLinecap="round" />
    <path d="M18.7125 3.00269L6.6008 3.03174C4.79311 2.94231 4.32962 4.28079 4.32962 4.93509C4.32962 5.52029 4.25115 6.3734 3.14322 7.97682C2.0353 9.58024 2.11856 10.0566 2.74331 11.1666C3.26183 12.0879 4.58068 12.4477 5.26834 12.5083C7.45256 12.556 8.51526 10.742 8.51526 9.46715C9.59879 12.6705 12.6803 12.6705 14.0534 12.3042C15.429 11.9372 16.6076 10.6236 16.8856 9.46715C17.0478 10.9043 17.5399 11.743 18.9939 12.3192C20.5 12.9161 21.7953 12.0038 22.4451 11.419C23.095 10.8342 23.5121 9.53584 22.3536 8.10886C21.5547 7.12476 21.2217 6.19768 21.1123 5.23682C21.049 4.68006 20.9933 4.0818 20.586 3.7011C19.9907 3.14473 19.1367 2.97592 18.7125 3.00269Z" stroke={color} strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round" />
  </svg>
)
